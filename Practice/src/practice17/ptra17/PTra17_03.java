...
/*メモ：while文の中で　(46行目)int num = Integer.parseInt(input);がtryかcatchの判定部分になる
 *      Exceptionがあれば、それ以降のtry中の処理はスキップされ、whileがturueになるまで繰り返される
 *      無事try通り進めばbreakごとに問題が進み得点が出る
 */
